...
func FirewallRulesResourceSchema(ctx context.Context) schema.Schema {
		...
		Attributes: map[string]schema.Attribute{
					...
					"attributes": schema.SingleNestedAttribute{
						Attributes: map[string]schema.Attribute{
							"created_at": schema.StringAttribute{
								...
								MarkdownDescription: "The date and time the firewall rule was created.",
							},
							"ip_address": schema.StringAttribute{
								Computed:            true,
								Description:         "The IP address or subnet for the firewall rule.",
								MarkdownDescription: "The IP address or subnet for the firewall rule.",
							},
							...
							"port": schema.StringAttribute{
								...
								MarkdownDescription: "The port or port range for the firewall rule.",
							},
							...
							"updated_at": schema.StringAttribute{
								...
								MarkdownDescription: "The date and time the firewall rule was last updated.",
							},
						},
			...
			"ip_address": schema.SingleNestedAttribute{
				...
				CustomType: IpAddressType{
					ObjectType: types.ObjectType{
						AttrTypes: IpAddressValue{}.AttributeTypes(ctx),
					},
				},
				Optional: true,
				Computed: true,
...
var _ basetypes.ObjectTypable = IpAddressType{}
...
func (t IpAddressType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func NewIpAddressValueNull() IpAddressValue {
	return IpAddressValue{
		state: attr.ValueStateNull,
	}
}

func NewIpAddressValueUnknown() IpAddressValue {
	return IpAddressValue{
		state: attr.ValueStateUnknown,
	}
}

func NewIpAddressValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (IpAddressValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing IpAddressValue Attribute Value",
				"While creating a IpAddressValue value, a missing attribute value was detected. "+
					"A IpAddressValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("IpAddressValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid IpAddressValue Attribute Type",
				"While creating a IpAddressValue value, an invalid attribute value was detected. "+
					"A IpAddressValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("IpAddressValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("IpAddressValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra IpAddressValue Attribute Value",
				"While creating a IpAddressValue value, an extra attribute value was detected. "+
					"A IpAddressValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra IpAddressValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewIpAddressValueUnknown(), diags
	}
...
func NewIpAddressValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) IpAddressValue {
	object, diags := NewIpAddressValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewIpAddressValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}
...
func (t IpAddressType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewIpAddressValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewIpAddressValueUnknown(), nil
	}
	...
	return NewIpAddressValueMust(IpAddressValue{}.AttributeTypes(ctx), attributes), nil
}
...
var _ basetypes.ObjectValuable = IpAddressValue{}

type IpAddressValue struct {
	state attr.ValueState
}

func (v IpAddressValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	attrTypes := make(map[string]tftypes.Type, 0)
...
func (v IpAddressValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v IpAddressValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v IpAddressValue) String() string {
	return "IpAddressValue"
}

func (v IpAddressValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v IpAddressValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
	return map[string]attr.Type{}
}
