...
func (d *ServerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	data.Size = types.StringValue(server.Size)
	data.Region = types.StringValue(server.Region)
	data.PhpVersion = types.StringValue(server.PhpVersion)
	data.PhpCliVersion = types.StringValue(server.PhpCliVersion)
	data.OpcacheStatus = types.StringValue(server.OpcacheStatus)
	data.DatabaseType = types.StringValue(server.DatabaseType)
	data.IpAddress = types.StringValue(server.IpAddress)
	data.PrivateIpAddress = types.StringValue(server.PrivateIpAddress)
	data.BlackfireStatus = types.StringValue(server.BlackfireStatus)
	data.PapertrailStatus = types.StringValue(server.PapertrailStatus)
	data.Revoked = types.StringValue(server.Revoked)
	data.CreatedAt = types.StringValue(server.CreatedAt)
	data.IsReady = types.StringValue(server.IsReady)
