...
func (d *SiteDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	data.Username = types.StringValue(site.Username)
	data.Directory = types.StringValue(site.Directory)
	data.Wildcards = types.StringValue(site.Wildcards)
	data.Status = types.StringValue(site.Status)
	data.Repository = types.StringValue(site.Repository)
	data.RepositoryProvider = types.StringValue(site.RepositoryProvider)
	data.RepositoryBranch = types.StringValue(site.RepositoryBranch)
	data.RepositoryStatus = types.StringValue(site.RepositoryStatus)
	data.QuickDeploy = types.StringValue(site.QuickDeploy)
	data.ProjectType = types.StringValue(site.ProjectType)
	data.App = types.StringValue(site.App)
	data.AppStatus = types.StringValue(site.AppStatus)
	data.SlackChannel = types.StringValue(site.SlackChannel)
	data.TelegramChatId = types.StringValue(site.TelegramChatId)
	data.TelegramChatTitle = types.StringValue(site.TelegramChatTitle)
	data.DeploymentUrl = types.StringValue(site.DeploymentUrl)
